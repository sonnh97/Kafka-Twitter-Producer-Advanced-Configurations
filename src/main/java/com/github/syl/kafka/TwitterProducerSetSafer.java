...
public class TwitterProducerSetSafer {

    Logger logger = LoggerFactory.getLogger(TwitterProducerSetSafer.class.getName());
    ...
    public TwitterProducerSetSafer() {}

    public static void main(String[] args) {
        new TwitterProducerSetSafer().run();
    }
